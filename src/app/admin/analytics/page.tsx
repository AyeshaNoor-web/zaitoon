...
export default function AdminAnalyticsPage() {
    ...
    const chartData = useMemo(() => {
        if (!data) return { revenueData: [], topItems: [], orderSplit: [], revenueSplit: [] }
        ...
        data.orders.forEach((o) => {
            ...
            typeRevenueMap.set(t, (typeRevenueMap.get(t) || 0) + o.total)
        })
        
        const totalSplit = Array.from(typeCountMap.values()).reduce((a, b) => a + b, 0)
        const totalRevenueSplit = Array.from(typeRevenueMap.values()).reduce((a, b) => a + b, 0)
        ...
        return { revenueData, topItems, orderSplit, revenueSplit }
    }, [data, branches])
